        ...
        <div className="flex flex-col items-center gap-3 px-4 py-6">
          ...
          <div className="mt-6 w-full max-w-[640px] bg-white border border-[#E6E7E8] rounded-[10px] shadow-[0px_1px_3px_rgba(0,0,0,0.12)] p-6">
            <label className="block font-[var(--font-proxima)] font-semibold text-[#2F2E2E]">
              {t("step3.state.label")}{" "}
              <span className="text-[#5A5A8A]">{t("step3.state.required")}</span>
            </label>
            ...
            >
              <option value="">{t("step3.state.placeholder")}</option>
              {STATES.map((s) => (
            ...
            {flow.detention.detainedState && (
              <div className="mt-6">
                <label className="block font-[var(--font-proxima)] font-semibold text-[#2F2E2E]">
                  ...
                  <span className="text-[#5A5A8A]">
                    {t("step3.facility.required")}
                  </span>
                </label>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFlow((prev) => ({
                      ...
                      detention: {
                        ...prev.detention,
                        facilityId: e.target.value || null,
                      },
                    }))
                  }
                >
                  <option value="">{t("step3.facility.placeholder")}</option>
                  {facilities.map((f) => (
