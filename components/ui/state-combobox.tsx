...
export function StateCombobox({ value, placeholder, onValueChange, onClear }: StateComboboxProps) {
  const { t } = useLanguage();
  ...
  // When open, show what the user is typing; when closed, show selected state or empty
    ...
    <div className="relative">
      <div className="relative flex items-center">
        <input
          ...
          value={displayValue}
          placeholder={open ? t("common.state.search") : placeholder}
          onChange={(e) => {
            ...
            filtered.map((state, i) => (
              <li
                ...
                className={cn(
                  ...
                  value === state && i !== highlightedIndex && "font-semibold"
                )}
              >
                {state}
              </li>
